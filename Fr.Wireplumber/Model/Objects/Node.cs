...
) : IWireplumberObject
{
    ...
    {
        FrWireplumberLib.SetMute(ObjectId, muted);
    }
    ...
    {
        FrWireplumberLib.SetVolumes(ObjectId, volumes);
    }
    ...
    {
        FrWireplumberLib.SetParams(ObjectId, [new(name, value)]);
    }
    ...
    public void OverrideTargetObject(string targetObject) =>
        FrWireplumberLib.SetMetadataEntry("default", ObjectId,
